...
const ResultsBody = ({navigation}) => {
    return (
        <View style={{alignItems:"center"}}>
            ...
            <TouchableOpacity style={styles.item} onPress={()=> navigation.push('Result')}>
                <Image
                source={{uri:'https://img.icons8.com/ios-filled/50/000000/book.png'}}
                style={styles.icon} 
                /> 
...
const ModuleInfo = (props) => (
    <TouchableOpacity style={styles.item}>
        ...
        style={styles.icon} 
        />
        <Text style={styles.itemText}>{props.module.moduleCode} - {props.module.moduleName}</Text>
    </TouchableOpacity>
)
