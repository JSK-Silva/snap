        ...
        <View style={{marginTop:100}}>
            <View style={styles.item}>
                ...
                <View style={{justifyContent:"flex-start", flexDirection:"row"}}>
                    <TouchableOpacity style={{margin:12}} onPress={()=> navigation.push("Batch 07 Results")}>
                        <LottieView 
            ...
            <View style={styles.item}>
                ...
                <View style={{justifyContent:"flex-start", flexDirection:"row"}}>
                    <TouchableOpacity style={{margin:12}} onPress={()=> navigation.push("Batch 08 Results")}>
                        <LottieView 
                        style={{height:70, alignSelf:"center", marginTop:10}}
                        source={require('../../assets/Anmations/add-button.json')}
                        autoPlay
